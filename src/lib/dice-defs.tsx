...
const icon = (Node: React.ComponentType<any>) => <Node size={18} color="#000" />

// 1) 피격 주사위 (D6)
export const hitD6: readonly DieFace[] = [
  { label: 'Any', value: 'any' },
  { label: 'Torso', value: 'torso' },
  { label: "L-Arm", value: 'left-arm' },
  { label: 'R-Arm', value: 'right-arm' },
...
export const weakAttackD8: readonly DieFace[] = [
  ...
  { label: <DiamondIcon filled={true} />, value: '◆', weight: 2 },
  { label: <div style={{ display: 'flex', gap: 2 }}><DiamondIcon filled /><DiamondIcon filled /></div>, value: '◆◆', weight: 2 },
  { label: <div style={{ display: 'flex', gap: 2 }}><DiamondIcon filled /><DiamondIcon filled /></div>, value: '◆◆', weight: 2 },
...
export const defenseD8: readonly DieFace[] = [
  { label: <div style={{ display: 'flex', gap: 2 }}><ShieldIcon /><ShieldIcon /></div>, value: 'shieldx2' },
